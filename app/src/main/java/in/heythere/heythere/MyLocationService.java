...
public class MyLocationService extends Service implements LocationListener {
    ...
    public MyLocationService(Context context) {
        ...
        updatethread = new Thread(new Runnable() { public void run() {

            String latitude_string=Double.toString(latitude);
            String longitude_string=Double.toString(longitude);
            updateServerLocation(latitude_string,longitude_string,"617842ff9cd03c8878fc8cc87aac2a07");
    ...
    private void updateServerLocation(String lat,String lng,String uid) {
        ...
        jsonParser.makeHttpRequest(LOC_UPDATE_URL, "POST", params);
